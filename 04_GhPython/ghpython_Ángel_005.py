...
def tree(point,length,a1,a2,iterations):
    ...
    if iterations>0 and choiceA>=20:
        iterations -= 1
        choiceB1 = rd.randint(0,100)
        choiceB2 = rd.randint(0,100)
        #if choiceB1 > (iterations/It*100):
        tree(Pt1,length/1.4,a1/1.1,a2/1.1,iterations)
        #if choiceB2 > (iterations/It*100):
        tree(Pt2,length/1.4,a1/1.1,a2/1.1,iterations)
    pts.extend([l0,l1,l2])
